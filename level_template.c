...
void level_template(){
	...
	char npc_dialogue[] ="Hello Player";
        ...
        while(1){
		//Conceptual code where if key_count =0, then = turns into blank
		//Simple NPC cycle.  Dont place him in a wall
		//conceptual code, will work later
		/* if time is 3 seconds, NPC move right, 
		if time is 6 seconds NPC move left reset time		*/
